...
namespace A60Insurance.Models
{
    ...
    public partial class Claim
    {
        ...
        public Claim() {
            ...
            Id = 0;
            ClaimIdNumber = string.Empty;
            ClaimDescription = string.Empty;
            CustomerId = string.Empty;
            PlanId = string.Empty;
            PatientFirst = string.Empty;
            PatientLast = string.Empty;
            Diagnosis1 = string.Empty;
            Diagnosis2 = string.Empty;
            Procedure1 = string.Empty;
            Procedure2 = string.Empty;
            Procedure3= string.Empty; 

            //TODO: finish this and other classes...
